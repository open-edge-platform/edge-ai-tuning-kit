    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-[900px] w-[90vw] p-0 overflow-hidden rounded-lg shadow-lg border">
        ...
        <Tabs defaultValue="upload" className="w-full">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                {ongoingGeneration && (
                  <Badge
                    variant="outline"
                    className="ml-2 bg-amber-50 text-amber-600 border-amber-200 dark:bg-amber-900/20 dark:text-amber-400 dark:border-amber-800"
                  >
          ...
          <div className="p-6 max-h-[calc(100vh-16rem)] ">
            <TabsContent
              value="upload"
              className="mt-0 animate-in fade-in-50 max-w-[98%] mx-auto"
            >
            ...
            <TabsContent
              value="add-pair"
              className="mt-0 animate-in fade-in-50 max-w-[98%] max-h-[calc(100vh-20rem)] "
            >
              <AddPairContent
                onAddPair={(messages) => {
                  onAddPair(messages);
