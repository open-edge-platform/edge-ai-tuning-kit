...
async def delete_project(service: Annotated[ProjectsService, Depends()], taskService: Annotated[TaskService, Depends()], id: int = Path(..., gt=0, le=ID_MAX)):
