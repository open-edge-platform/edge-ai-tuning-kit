...
class LORATrainer:
    ...
    def _load_model_and_tokenizer(self, dtype: torch.dtype = torch.bfloat16, attention_implementation: str = "eager"):
...
def main(args):
    ...
    trainer = LORATrainer(model_args.model_name_or_path, model_args.device)
